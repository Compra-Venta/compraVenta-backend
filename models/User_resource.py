...
class User:
        def __init__(self,email, password, name, birth_year, country, balance):
                self.email = email
        ...
        def find_by_email(cls, email):
                ...
                client.close()
                if result:
                        return cls(result['email'], result['password'], result['name'], result['birth_year'], result['country'], result['balance']), str(result['_id'])
                else:
                        return None, None
